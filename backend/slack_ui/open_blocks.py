...
from .models import Base, Commitment, Schedule, ActionLog, Punishment
...
def open_base_commitment_modal(user_id: str = None) -> Dict[str, Any]:
    """
    ...
    next_idx = max(len(commitments), 3) + 1
...
def remind_blocks(schedule_id: str, thread_ts: str = None) -> List[Dict[str, Any]]:
    """
